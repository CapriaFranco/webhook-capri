          ...
          <table className="results-table">
            ...
            <tbody className="results-table-body">
              {results.map((result, index) => {
                ...
                const formattedTime = result.timestamp ? new Date(result.timestamp).toLocaleTimeString() : "-"

                const formattedDuration = typeof result.responseTime === "number" ? `${result.responseTime}ms` : "-"
                ...
                return (
                  <tr key={index} className="results-table-row">
                    <td className="results-table-cell results-table-cell-id">{index + 1}</td>
                    <td className="results-table-cell results-table-cell-user">{result.userName}</td>
                    ...
                    <td className="results-table-cell results-table-cell-time">{formattedTime}</td>
                    <td className="results-table-cell results-table-cell-phone">{result.phone}</td>
                    <td className="results-table-cell results-table-cell-duration">{formattedDuration}</td>
